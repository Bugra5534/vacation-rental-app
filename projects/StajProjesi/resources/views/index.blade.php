   ...
   <!-- ***** Cars Starts ***** -->
    <section class="section" id="trainers">
        <div class="container">
            ...
            <div class="main-button text-center">
                <a href="vacations.blade.php">View Vacations</a>
            </div>
        </div>
    </section>
    <!-- ***** Cars Ends ***** -->

    <section class="section section-bg" id="schedule" style="background-image: url({{asset('assets/images/about-fullscreen-1-1920x700.jpg')}})">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading dark-bg">
                        <h2>Read <em>About Us</em></h2>
                        <img src="{{asset('assets/images/line-dec.pn')}}g" alt="">
                        <p>Nunc urna sem, laoreet ut metus id, aliquet consequat magna. Sed viverra ipsum dolor, ultricies fermentum massa consequat eu.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row" id="tabs">
              <div class="col-lg-4">
                <ul>
                  ...
                  <div class="main-rounded-button"><a href="blog.blade.php">Read More</a></div>
                </ul>
              </div>
              <div class="col-lg-8">
                <section class='tabs-content'>
                  <article id='tabs-1'>
                    ...
                    <div class="main-button">
                        <a href="blog-details.blade.php">Continue Reading</a>
                    </div>
                  </article>
                  <article id='tabs-2'>
    ...
    <section class="section" id="features">
        <div class="container">
            ...
            <div class="main-button text-center">
                <a href="testimonials.blade.php">Read More</a>
            </div>
        </div>
    </section>
